<div class="col-lg-7">
    ...
    <form class="form-horizontal" method="post">
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="inputPhone" class="form-control" id="inputTelephone" placeholder="numero de téléphone" value="${form_contact.phone}">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="inputFname" class="form-control" id="inputPrenom" placeholder="prénom" value="${form_contact.fname}">
            </div>
        </div>
        <div class="form-group">
